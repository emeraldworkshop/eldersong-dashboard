...
export async function addNewUser({
  ...
  await supabaseAdmin.auth.resetPasswordForEmail(email, {
    redirectTo: 'https://eldersongplus-com.expo.app/update-password',
  });
...
export async function updateUserById(
  ...
  // 2. Optionally generate password recovery link
  await supabaseAdmin.auth.resetPasswordForEmail(email, {
    redirectTo: 'https://eldersongplus-com.expo.app/update-password', // this is the page you want the user redirected to after email click
  });
